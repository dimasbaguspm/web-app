...
interface AccountGroupCardProps extends Pick<CardProps, 'as' | 'size' | 'shape' | 'bordered' | 'actions'> {
  accountGroup: AccountGroupModel;
  onClick?: (accountGroup: AccountGroupModel) => void;
}

export const AccountGroupCard: FC<AccountGroupCardProps> = ({ accountGroup, onClick }) => {
