import { useApiHiDeleteAppProfile } from '@dimasbaguspm/hooks/use-api';
...
interface DeleteAppProfileModalProps {
  appProfileId: number;
}

export const DeleteAppProfileModal: FC<DeleteAppProfileModalProps> = ({ appProfileId }) => {
  ...
  const [deleteAppProfile, , { isPending }] = useApiHiDeleteAppProfile();
