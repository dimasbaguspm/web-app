...
export type SearchAppProfilesModel = operations['getApp-profiles']['parameters']['query'];
...
export type SearchGroupMembersModel = operations['getGroup-members']['parameters']['query'];
