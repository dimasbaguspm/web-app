...
export type SearchAccountsModel = operations['getAccount']['parameters']['query'];
...
export type SearchSummaryTransactionsModel = operations['getSummaryTransactions']['parameters']['query'];
export type SummaryTransactionsModel =
  operations['getSummaryTransactions']['responses']['200']['content']['application/json'];
export type SearchSummaryAccountsModel = operations['getSummaryAccount']['parameters']['query'];
export type SummaryAccountsModel = operations['getSummaryAccount']['responses']['200']['content']['application/json'];
export type SearchSummaryCategoriesModel = operations['getSummaryCategory']['parameters']['query'];
export type SummaryCategoriesModel =
  operations['getSummaryCategory']['responses']['200']['content']['application/json'];
export type SearchSummaryTotalTransactionsModel = operations['getSummaryTotal']['parameters']['query'];
